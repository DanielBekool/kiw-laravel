    <!--Start Header Menu-->
        <div x-data="{ open: false, openSubMenu: null }" > 
            <header x-data="{ open: false }" class=" absolute top-0 left-1/2 -translate-x-1/2 lg:w-[1200px] z-99999">
                <div class="lg:max-w-[1200px] mx-auto  flex pt-5 justify-between gap-15">
                            ...
                            <ul class="flex flex-row justify-between gap-2 items-end grow">
                                ...
                                <li class="relative group">
                                    ...
                                    <ul class="absolute overflow-hidden left-0 mt-2 w-60 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                                        <li>
                                            <a href="#" class="block px-4 py-2 text-[var(--color-heading)] hover:bg-[var(--color-lightblue)] hover:text-white">Profil Perusahaan</a>
                                        </li>
                                        <li>
                                            <a href="#" class="block px-4 py-2 text-[var(--color-heading)] hover:bg-[var(--color-lightblue)] hover:text-white">Visi Misi & Tata Nilai</a>
                                        </li>
                                        <li>
                                ...
                                <li class="relative group">
                                    ...
                                    <!-- Submenu -->
                                    <ul class="absolute overflow-hidden left-0 mt-2 w-48 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                                        <li>
                  ...
                  var(--color-white)          <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
